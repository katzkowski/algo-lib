...
slug: minimax
date: 2020-12-28
preview-text: The Minimax algorithm determines the best score in a game after players get to move a certain number of times. Minimax is only applicable in 2-player games, where the gain of player *A* is exactly the loss of player *B*.
